...
module "cc_vpc" {
    source = "git@github.com:devoteamgcloud/tf-gcp-modules-network-vpc.git?ref=v0.0.1"
...
module "cc_shared_vpc" {
    source = "git@github.com:devoteamgcloud/tf-gcp-modules-network-xpn.git?ref=v0.0.1"
